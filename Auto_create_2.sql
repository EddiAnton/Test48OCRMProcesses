...
FB_PRODUCTORDMEMB_DATAID_4 CHAR(12);
...
FB_PRODUCTORDMEMB_DATAID_4 := SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_DATA');
...
FACETYPE, FACEID, DATEBEGIN, ISEIO, ISNOCOPOP, ISTITLENOENDDATE, ISMANAGEBOARD, ASSOCIATIONTYPE, TITLE, TYPEOFFOUNDATION, NOTES)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_1, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'B', '410', TO_DATE('2012-08-18','YYYY-MM-DD'), 'F', 'F', 'F', 'T', 'ОБЩ_РУКОВОДИТЕЛЬ', 'Старший зам младшего директора',
'ЗАКОННЫЙ', 'Срок полномочий по Уставу от редакции 15.05.2015 - 5 лет');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_FACE (FB_PRODUCTORDMEMB_FACEID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
FACETYPE, FACEID, DATEBEGIN, ISEIO, ISNOCOPOP, ISTITLENOENDDATE, ASSOCIATIONTYPE, TITLE, NOTES)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_2, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'B', '578', TO_DATE('2012-10-10','YYYY-MM-DD'), 'T', 'T', 'F', 'ОБЩ_РУКОВОДИТЕЛЬ', 'Гл. бухгалтер', 'Срок полномочий по Уставу от редакции 15.05.2015 - 3 года');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_FACE (FB_PRODUCTORDMEMB_FACEID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
FACETYPE, FACEID, DATEBEGIN, ISEIO, ISNOCOPOP, ISTITLENOENDDATE, TYPEOFFOUNDATION, ASSOCIATIONTYPE, CAPITALPERCENT)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_3, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'F', '3476', TO_DATE('2012-08-18','YYYY-MM-DD'), 'F', 'F', 'F', 'BEN3', 'УЧРЕДИТЕЛЬ', '100');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_FACE (FB_PRODUCTORDMEMB_FACEID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
FACETYPE, FACEID, DATEBEGIN, ASSOCIATIONTYPE, TYPEOFFOUNDATION)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_4, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'L', '347600', TO_DATE('2020-08-08','YYYY-MM-DD'), 'БЕНЕФИЦИАР', 'BEN3');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_DATA (FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
MEMBERDATATYPE, ISPRIMARY, FB_PRODUCTORDERMEMBERID, BIRTHDATE, BIRTHPLACE, FIRSTNAME, LASTNAME, MIDDLENAME,
GENDER, INN, COUNTRY, NOCITIZENSHIP, IDCFT, MEMBERCLASS, IS_CONNECTED_BP, SIGNATURETYPEBP, ROLEBP, PHONEBP, MAILBP)
...
'М', '7474567891', 'USA', 'F', '3476', 'CL_PRIV', 'T', 'GROUP_ONE', 'SIGNER', '8 (555) 322-23-32', 'test@mail.bp');
...
'Ж', '250504608300', 'RUS', 'F', '578', 'CL_PRIV');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_DATA (FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
MEMBERDATATYPE, ISPRIMARY, FB_PRODUCTORDERMEMBERID, BIRTHDATE, BIRTHPLACE, FIRSTNAME, LASTNAME, MIDDLENAME,
GENDER, INN, COUNTRY, NOCITIZENSHIP, IDCFT, MEMBERCLASS)
VALUES (FB_PRODUCTORDMEMB_DATAID_4, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
1, 'F', FB_PRODUCTORDERMEMBERID, TO_DATE('1978-09-30','YYYY-MM-DD'), 'Темиртау', 'Антон', 'Эдуард', 'Николаевич',
'М', '747456789190', 'RUS', 'F', '347600', 'CL_PRIV');
...
INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_DOCS (FB_PRODUCTORDMEMB_DOCSID, FB_PRODUCTORDMEMB_DATAID, FB_PRODUCTORDERMEMBERID, CREATEUSER,
CREATEDATE, MODIFYUSER, MODIFYDATE, DOCSID, REGNUMBER, STARTDATE, DOCTYPE)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_DOCS'), FB_PRODUCTORDMEMB_DATAID, FB_PRODUCTORDERMEMBERID, 'ADMIN',
now_timestamp, 'ADMIN', now_timestamp, '232', '1067746136159', TO_DATE('2010-11-25','YYYY-MM-DD'), 'REGEGR');
...
'291', 'PHONE', '7(495) 478-3077', '2', 'F', 'F', 'Генеральный директор');
...
INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_CONT (FB_PRODUCTORDMEMB_CONTID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
CUST_CHANNELID, CHANNEL_TYPE, CHANNEL_VALUE, CHANNEL_SUBTYPE, ISACTIVE, ISPRIMARY)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_CONT'), FB_PRODUCTORDMEMB_DATAID_1, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'314', 'PHONE', '79255200347', '2', 'T', 'F');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_CONT (FB_PRODUCTORDMEMB_CONTID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
CUST_CHANNELID, CHANNEL_TYPE, CHANNEL_VALUE, ISACTIVE, ISPRIMARY)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_CONT'), FB_PRODUCTORDMEMB_DATAID_1, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'322', 'MAIL', 'SvA@lukoil.com', 'T', 'F');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_CONT (FB_PRODUCTORDMEMB_CONTID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
CUST_CHANNELID, CHANNEL_TYPE, CHANNEL_VALUE, CHANNEL_SUBTYPE, ISACTIVE, ISPRIMARY)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_CONT'), FB_PRODUCTORDMEMB_DATAID_2, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'338', 'PHONE', '79179171120', '2', 'T', 'F');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_CONT (FB_PRODUCTORDMEMB_CONTID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
CUST_CHANNELID, CHANNEL_TYPE, CHANNEL_VALUE, ISACTIVE, ISPRIMARY)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_CONT'), FB_PRODUCTORDMEMB_DATAID_2, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'343', 'MAIL', 'Test@lukoil.com', 'T', 'F');
...
CITY, CITYFIAS, FULLADDRESS, COUNTRY)
...
'Немчиновка', 'abbc9105-0460-472a-ba54-d6741881f39b', 'РОССИЯ,630000,обл Московская,г Одинцово,с Немчиновка,,,,', 'RUS');
...
'450', '12/455', 'Лицензия', '1780', TO_DATE('2012-08-18','YYYY-MM-DD'),
