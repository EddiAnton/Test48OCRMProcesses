...
FACETYPE, FACEID, DATEBEGIN, ISEIO, ISMANAGEBOARD, ASSOCIATIONTYPE, TITLE, TYPEOFFOUNDATION, NOTES)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_1, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'B', '410', TO_DATE('2012-08-18','YYYY-MM-DD'), 'T', 'T', 'ОБЩ_РУКОВОДИТЕЛЬ', 'Старший зам младшего директора',
'ЗАКОННЫЙ', 'Срок полномочий по Уставу от редакции 15.05.2015 - 5 лет');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_FACE (FB_PRODUCTORDMEMB_FACEID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
FACETYPE, FACEID, DATEBEGIN, ASSOCIATIONTYPE, TITLE, NOTES)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_2, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'B', '414', TO_DATE('2012-10-10','YYYY-MM-DD'), 'ОБЩ_РУКОВОДИТЕЛЬ', 'Гл. бухгалтер', 'Срок полномочий по Уставу от редакции 15.05.2015 - 3 года');

INSERT INTO SYSDBA.FB_PRODUCTORDMEMB_FACE (FB_PRODUCTORDMEMB_FACEID, FB_PRODUCTORDMEMB_DATAID, CREATEUSER, CREATEDATE, MODIFYUSER, MODIFYDATE,
FACETYPE, FACEID, DATEBEGIN, TYPEOFFOUNDATION, ASSOCIATIONTYPE, CAPITALPERCENT)
VALUES (SYSDBA.FCREATESLXID ('FB_PRODUCTORDMEMB_FACE'), FB_PRODUCTORDMEMB_DATAID_3, 'ADMIN', now_timestamp, 'ADMIN', now_timestamp,
'F', '444', TO_DATE('2012-08-18','YYYY-MM-DD'), 'BEN3', 'УЧРЕДИТЕЛЬ', '100');
