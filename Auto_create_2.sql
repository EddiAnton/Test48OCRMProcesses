...
'B', '410', TO_DATE('2012-08-18','YYYY-MM-DD'), 'T', 'F', 'F', 'T', 'ОБЩ_РУКОВОДИТЕЛЬ', 'Старший зам младшего директора',
...
'B', '414', TO_DATE('2012-10-10','YYYY-MM-DD'), 'F', 'T', 'F', 'ОБЩ_РУКОВОДИТЕЛЬ', 'Гл. бухгалтер', 'Срок полномочий по Уставу от редакции 15.05.2015 - 3 года');
...
'F', '444', TO_DATE('2012-08-18','YYYY-MM-DD'), 'F', 'F', 'F', 'BEN3', 'УЧРЕДИТЕЛЬ', '100');
